...
def import_all_data(sql_tables, common_column):
    ...
    conn = sqlite3.connect(r"C:\Users\15404\Documents\GitHub\research_project\Final_Processing\SQL_DB\new_db_3.db")
    curs = conn.cursor()
...
def import_single_table(sql_table):
    # Establish a database connection
    conn = sqlite3.connect(r'C:\Users\15404\Documents\GitHub\research_project\SQL_DB\new_db_3.db')
    curs = conn.cursor()
